# -*- coding: utf-8 -*-
"""
Created on Sun Oct 17 01:29:07 2021
...
#The first pattern: two digits without weird characters before the number. To 
#limit the range the years, we assume most of the patients borned after 1960
pattern1 = '[^-%0-9a-zA-Z/.><@+()|:=][6-9][0-9]'

#The second pattern: specifc 2000 or 00 year
pattern2 = '[^-%0-9a-zA-Z/.><@+()|:=][0][0][^-%0-9a-zA-Z/.><@+()|:=]'

#The third pattern: 19xx year. No one can born from 18xx year
pattern3 = '[1][9][0-9][0-9]'

#The four pattern: 20xx year. No one can born after 2021 year
pattern4 = '[2][0][0-2][0-9]'
dateYear_pattern = '('+pattern1+'|'+pattern2+'|'+pattern3+'|'+pattern4+')'

# comp5iling the reg_ex would save sime time!
ph_reg = re.compile(dateYear_pattern)
...
def deid_dateyear(text_path= 'id.text', output_path = 'phone.phi'):
    """
    Inputs: 
